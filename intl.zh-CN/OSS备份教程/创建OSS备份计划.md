...
-   备份OSS将产生OSS请求费用，该费用由OSS收取。更多信息，请参见[OSS计量计费](/intl.zh-CN/计量计费/计量项和计费项/计量计费概述.md)。
...
5.  在创建备份计划面板，按照以下说明填写各项参数，然后单击**确定**。
    ...
    **说明：** 您可以享受免费备份计划，计划到期日期为创建备份计划之日起1个月内，假设您于2020年2月14日创建备份计划，则您可享受的免费备份计划到期日期为2020年3月14日。
    ...
    2.  如果您需要编辑高级设置，请单击**显示高级设置**，并单击**立即转为付费使用**启用高级设置，并按以下说明填写各项参数。
        ...
        |备份库名称|指定备份库的名称。|
        |是否使用OSS清单|是否使用OSS清单功能备份OSS。默认值为**不使用**。大数据量OSS备份，建议使用该功能，具体操作请参见[使用OSS清单创建大数据量OSS备份计划](/intl.zh-CN/OSS备份教程/使用OSS清单创建大数据量OSS备份计划.md)。|
